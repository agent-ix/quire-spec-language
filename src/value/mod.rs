...
pub use expression::{
    ...
    CollectionLoss, CollectionProperty, DepthAboveMaximum, DispatchCandidate, DispatchOperation,
    DispatchTable, EnumBinding, Evaluation, Expression, FieldInitializer, FunctionDeclaration,
    InputRefusal, LocatedLoss, Location, MeasureObligation, Obligation, Origin,
    PackageDeclarations, ProvedInterval, ValueLoss, MAX_CHECKING_DEPTH,
};
