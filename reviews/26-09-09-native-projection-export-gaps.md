...
rollup at 293/301. TC-107 carries real trace attributes on four binary tests
and two adapter unit tests.
...
The actual full/focused runs verify the scoped controls; matrix status
reconciliation remains unavailable because of the catalog column mismatch.
Existing global metric/integration gaps remain open. Optional semantic
