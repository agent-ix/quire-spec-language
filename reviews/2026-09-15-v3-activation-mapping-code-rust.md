...
scope: "QSL #111 / PR #110; Plan-012 Task-045; FR-054; TC-143; native_temporal::v2; compiled-protocol /3"
review_set: subset
relationships:
...
| --- | --- | --- | --- |
| FND-001 | low | No scoped review finding remains. QSL correctly exposes only its admitted temporal facts and strict mapping; Protocol #6 retains construction, replay, and contradiction handling for the complete FR-300 binding. | FR-054; TC-143; Protocol FR-019 |
...
- TC-143 traces every FR-054 acceptance criterion and executes the canonical,
...
| TC-143 exact control in `compiled_protocol_v2` | pass |
