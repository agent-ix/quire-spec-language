...
criteria have explicit cases; all 14 cases remain planned. Existing TM-001–004
...
| --- | --- | --- | --- |
| FR-019 | FR-019-AC-1 | TC-078, TC-089 | 🚧 Planned |
| FR-019 | FR-019-AC-2 | TC-078 | 🚧 Planned |
| FR-019 | FR-019-AC-3 | TC-078 | 🚧 Planned |
| FR-019 | FR-019-AC-4 | TC-079 | 🚧 Planned |
| FR-019 | FR-019-AC-5 | TC-080 | 🚧 Planned |
| FR-019 | FR-019-AC-6 | TC-080 | 🚧 Planned |
...
| FR-021 | FR-021-AC-1 | TC-090 | 🚧 Planned |
...
| --- | --- | --- | --- |
| NFR-007 | Test: negative-abuse-testing | TC-088; offered/emitted bytes, string content, entries, depth, every bounded pass and independent frontend limits | 🚧 Planned |
| NFR-005 | Inspection and existing Rust gates | Source/dependency/CI review and actual Rust qualification | 🚧 Planned for new package scope |

## Test Case Summary

| Test ID | Title | Type | Priority | Traces To | Status |
| --- | --- | --- | --- | --- | --- |
| TC-078 | Retain complete package inventories | Integration | P1 | FR-019-AC-1, FR-019-AC-2, FR-019-AC-3 | 🚧 Planned |
| TC-079 | Retain package resolutions and obligations | Integration | P1 | FR-019-AC-4 | 🚧 Planned |
| TC-080 | Bind package semantics and features | Property | P1 | FR-019-AC-5, FR-019-AC-6 | 🚧 Planned |
...
| TC-090 | Qualify native canonical bytes and domain vectors | Property | P1 | FR-021-AC-1, FR-021-AC-6 | 🚧 Planned |
| TC-091 | Reject static identity and projection substitutions | Property | P1 | FR-021-AC-3, FR-021-AC-4, FR-021-AC-5 | 🚧 Planned |

## Test Matrix Rules

EARS/requirement grammar was run before updating this matrix: all 218 then-present
spec documents were grammar-clean after the identity/reader-order additions.
...
All 14 cases and five package metrics remain unimplemented/unexecuted.
The native static canonical derivation is included in this slice, with explicit
independent byte/hash vectors and mutation controls planned. Shared-domain
