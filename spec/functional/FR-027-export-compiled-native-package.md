...
FR-027-AC-10 (the `libraries` member) is implemented under QSL-255 part (b) and backed by TC-446 step 7. Library source files count toward the request's `programs` file limit; FR-027 names no separate category.
