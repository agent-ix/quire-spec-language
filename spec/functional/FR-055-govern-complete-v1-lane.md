...
- QSpec complete-V1 semantic baseline `7f9315774833c20fcfbcf425ffeb8e2619d1b84c` (the QSpec PR #72 merge, amending the QSpec #68 complete scalar contracts over the PR #64 baseline).
...
| --- | --- | --- |
| FR-055-AC-1 | Plan-013 identifies QSpec `7f9315774833c20fcfbcf425ffeb8e2619d1b84c`, contains exactly the 83 accepted Agent-A capability identities and introduces no local semantic replacement. | Test (TC-144) |
