...
- QSpec complete-V1 semantic baseline `8d0fbad`.
...
| --- | --- | --- |
| FR-055-AC-1 | Plan-013 identifies QSpec `8d0fbad`, contains exactly the 83 accepted Agent-A capability identities and introduces no local semantic replacement. | Test (TC-144) |
