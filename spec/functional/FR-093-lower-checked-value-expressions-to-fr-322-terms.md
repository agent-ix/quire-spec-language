...
is finite by default ([NFR-011](../non-functional/NFR-011-bound-value-checking-work.md),
100000 units), so at the defaults a nine-record cluster refuses. A walk that would
