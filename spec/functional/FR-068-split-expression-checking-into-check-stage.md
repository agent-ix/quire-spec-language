...
- The `value` K-copy modules, each only while it exists: `value::collection`,
  `value::composite`, `value::equality` and `value::rational`.
  ...
  module. `value::decimal`, `value::ieee`, `value::numeric` and
  `value::text` left this list under QSL-131 O3, which deleted the four
  modules.
