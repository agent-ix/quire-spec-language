...
- The `value` K-copy modules, each only while it exists: `value::collection`,
  ...
  `value::numeric`, `value::outcome`, `value::rational` and `value::text`.
