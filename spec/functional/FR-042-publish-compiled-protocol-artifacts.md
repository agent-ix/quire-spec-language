...
consumer story for FR-042-AC-11 and FR-042-AC-12. Neither this recipe nor
TC-121 vendors anything against QSpec main: PLAT-887 removed the closed
native-definition registry's vendored resource tree, and the registry
([definition_source.rs](../../src/linking/composed/definition_source.rs))
resolves a definition or rule by the caller-supplied artifact's own identity
and revision, not by comparing its bytes to a copied snapshot.
