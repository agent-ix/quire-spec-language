...
### US-014-EX-5: Dimensions and units declared in source are admitted

- **Given** source that declares base and derived dimensions and units
  over them, one with an offset, spelled with `rational` and `decimal`
  numbers.
