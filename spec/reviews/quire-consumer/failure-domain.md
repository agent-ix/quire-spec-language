---
id: SR-206
title: "failure-domain review of the actual Quire consumer"
type: SpecReview
...
selectors, and each foreign identity/path/package field. Tests compare actual
variant payloads before extraction. Fence geometry, exact body bytes and map
construction have separate helpers; Quire remains the sole Markdown extractor.
