...
Four unresolvable IT scenario attributes were removed while real FR/TC tags
remain. TM-007 explicitly names the extraction feature requirement. Both minimal
and all-feature lint/test lanes are retained in the dispatch-only workflow.
