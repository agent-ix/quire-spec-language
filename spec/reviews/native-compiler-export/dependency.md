...
Compilation is a command module taking bounded intake explicitly; file reading no longer owns the static compiler. Both run and compile use the same compiler functions. No dependency or hosted workflow changes were introduced.
