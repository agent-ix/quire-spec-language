...
Typed request formats, one parsed Command enum and explicit FileCounts remove the reviewed drift points. Exact artifact output and existing supported command behavior remain exercised.
