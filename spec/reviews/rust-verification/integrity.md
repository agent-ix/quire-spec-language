...
workflow changes. Only workflow_dispatch is permitted; push, pull-request, schedule and other events cannot trigger owned workflows. The change neither grants dispatch permission nor weakens Rust test/lint assertions.
