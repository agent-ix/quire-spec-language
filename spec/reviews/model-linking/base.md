---
id: SR-030
title: "base review of LC02 evidence design"
type: SpecReview
analysis: base
...
The ten existing FR-005/006 acceptance criteria now each have a discrete TC and a matrix row. IDs TC-020–029, TM-003 and IT-005 follow the actual catalog and extend the existing sequences without overlap. US-002 supplies actor/value and traces through StR-001; the requirements themselves are unchanged. The six coverage rules are addressed at the current AC scope, including ambiguity order, partial-success prevention, finite guard edges and observation-qualified facts. This does not claim complete future API/budget coverage: those contracts are prerequisites explicitly named in IT-005.
...
review set. The root index now contains IT-005 and records the owner's internal adoption. The ten AC/TC mappings and six-rule analysis are unchanged. IT-005 now states the inspected fixture bounds accurately: both scalar declarations use 0..1000. The distinct stable identities and containing models still require separately qualified inputs. FND-001/002 and the conditional verdict remain.
