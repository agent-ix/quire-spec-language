...
- FND-001 resolved: §8 and Decision 4 carry one merge order, #228 → #204 →
  #200, from the ARCH-01 comment on #207.
- FND-002 resolved: Consequences cites #212's seven change scenarios and its
  failure rule.
- FND-003 resolved: L1-D1 reads "Whether each of … waits on #185".
