...
- §8 now gives one merge order, #228 → #204 → #200, and it matches the ARCH-01
  rulings and §3. The items gated on Layer 1 and the IR keep PRs that change
  OBS facts are all listed.
...
| FND-005 | medium | resolved | §8 adds every ARCH-01 item whose disposition names a Layer 1 ticket, the IR keep PRs that change OBS-027 and OBS-036, and FCD PR #200. The out-of-scope remainder is sent to #207. One edge case is new finding FND-003. |
...
- FND-003 resolved: the capability-vocabulary item is recorded in §8 as revise,
  feeding #229 and DA-11.
