...
FND-001 fixed: §4 "Bounded request" and "Available finite bound". FND-002 fixed: model normalization stays B-2; NFR-012 unchanged. FND-003 fixed: TC-220 row. FND-004 fixed: §1 "one configured number". FND-005 fixed: `FiniteBound` variants and `DomainKey`. FND-006 fixed: §9 note and Consequences. FND-007 fixed: §4 "IR's predicate". FND-008 fixed: A-4 safety fragment. FND-009 fixed: A-4 charges per visit; infinite-trace has no intervals. FND-010 fixed: guard dropped. FND-011: the QSpec ticket is reported to the coordinator; §13 item 1 records the gap.
