...
FND-001 fixed: `spec/tests.md` TC-220 marks AC-6's check-time row and AC-7 pending under QSL-160; AC-3 is unchanged (model walk stays B-2). FND-002 fixed: FR-082 narrowed, no contradiction. FND-003 fixed: FR-082 states the `actual` counter and the absent `Locus` (FR-096's no-source-region case). FND-004: the named tests are the implementing tickets' acceptance criteria; §11 lists each interface they must exercise. FND-005 fixed: §6 names the QSL side (extent classification) and CG side (QSpec FR-290-AC-6). FND-006 fixed: scenario 5 replay is QSL-43's (§11). FND-007 fixed: §8 names three consumers. FND-008 fixed: §1 lists the one reclassified type.
