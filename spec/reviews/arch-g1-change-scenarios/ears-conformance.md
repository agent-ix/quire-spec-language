...
| FND-006 | low | Rule 8 is stated five times: Decision 8, the §1.1 skeleton bullet, §2.3, the §9 RT #53 row and Consequences. Only Decision 8 and §2.3 carry the full rule, so the copies can drift. Fix: keep the full text in §2.3, and cite "§2.3 rule 8" in the skeleton bullet, the RT #53 row and Consequences. | ADR-011:135-143, ADR-011:221-225, ADR-011:800, ADR-011:942-946 |
