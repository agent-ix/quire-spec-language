...
The binary owns argv and stream handling. The existing command module remains the public filesystem adapter; core compilation/evaluation stays free of I/O. Its JSON projection is now immutable, while the native execution API retains the full typed runtime report.
