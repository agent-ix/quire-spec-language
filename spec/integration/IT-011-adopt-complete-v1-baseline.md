...
`quire-specification` revision `4780a9e6119bb86ffb1322fe0a141ef3905b11ef`. The adoption must preserve existing
...
`4780a9e6119bb86ffb1322fe0a141ef3905b11ef` and the QSL repository-local Plan-013 delivery graph. QSpec owns
...
commit `4780a9e6119bb86ffb1322fe0a141ef3905b11ef`, the QSpec #68 merge that advanced the PR #64 baseline with the
complete scalar contracts. QSL issue #116 and downstream issues #117 through #123, plus
...
1. Select QSpec `4780a9e6119bb86ffb1322fe0a141ef3905b11ef` and compare Plan-013's normative references with the
