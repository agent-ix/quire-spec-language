...
| TC-160 | Every family implements the six-part checked contract with no bypass | Unit | P1 | FR-062-AC-1..FR-062-AC-7, FR-062-AC-9, FR-062-AC-13, FR-057-AC-10 | ✅ Passed locally for AC-2, AC-5 (hook level), AC-7 backed by TC-378, and AC-12; partly for AC-3 (third clause only, QSL-246 owns the rest), AC-6 (first sentence only, QSL-246 owns the rest) AC-4 (step 5) and AC-13 (step 10: RR-1 to RR-13 and RR-15 to RR-17, QSL-266; RR-14 does not parse, its function name `all` is a reserved word); AC-1 owned by QSL-140/QSL-242; AC-9 unbacked (QSL-242) |
