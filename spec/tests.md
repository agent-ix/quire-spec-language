...
| TC-160 | Every family implements the six-part checked contract with no bypass | Unit | P1 | FR-062-AC-1..FR-062-AC-7, FR-062-AC-9, FR-062-AC-13, FR-057-AC-10 | ✅ Passed locally for AC-2, AC-4 (step 5, QSL-266), AC-5 (hook level), AC-7 backed by TC-378, AC-12, and AC-13 (steps 10 and 11, QSL-266); partly for AC-3 (third clause only, QSL-246 owns the rest) and AC-6 (first sentence only, QSL-246 owns the rest); AC-1, AC-9 and AC-5's third clause amended by QSL-242 (no `package` hook; S4 emitter omission closure) and unbacked: steps 1, 8 and step 6's `Incomplete` assertion have no tagged test (follow-up, not yet filed) |
