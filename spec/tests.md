...
| TC-246 | ResolvedSourcePackage is retired, with no dangling caller | Integration | P1 | FR-087-AC-7, FR-087-CON-4 | 🚧 Planned; the dependency half exists (FR-099); runs once FR-110 is implemented and FR-087's held FR-131 rows are ruled (QSL-234); retirement: QSL-269; see FR-087 Status |
...
| TC-490 | E3 resolves header profile selections against the DefinitionLock catalog | Integration | P1 | FR-110-AC-1, FR-110-AC-2, FR-110-AC-3, FR-110-AC-4, FR-110-AC-5, FR-110-AC-6 | 🚧 Planned; QSL-234 |
...
records: TC-246 runs once FR-110 is implemented and the held FR-131 rows are ruled (QSL-234; retirement: QSL-269), and TC-379 passes steps 1 and 3 (QSL-255 part b).
