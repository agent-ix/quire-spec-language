...
| TC-415 | Each checked Value expression lowers to its FR-322 node with its catalogued operation | Unit | P1 | FR-093-AC-1, FR-093-AC-2, FR-093-AC-3, FR-093-AC-4, FR-093-AC-5, FR-093-AC-6, FR-093-AC-8, FR-093-AC-10, FR-093-AC-11, FR-093-AC-14 | 🚧 Implemented on the QSL-156 A4b branch, pending merge, except steps 8 and 9 (QSL-212); step 6 needs the QSpec lock accessor |
