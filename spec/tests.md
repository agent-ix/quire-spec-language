...
| TC-160 | Every family implements the six-part checked contract with no bypass | Unit | P1 | FR-062-AC-1..FR-062-AC-7, FR-062-AC-9, FR-062-AC-13, FR-057-AC-10 | ✅ Passed locally for AC-2, AC-4 (step 5, QSL-266), AC-5 (hook level), AC-7 backed by TC-378, AC-12, and AC-13 (steps 10 and 11, QSL-266); AC-3 (all three clauses, QSL-246, for `src/check` and `src/family`) and AC-6 (QSL-246); AC-1 owned by QSL-140/QSL-242; AC-9 unbacked (QSL-242) |
