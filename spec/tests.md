...
| TC-160 | Every family implements the six-part checked contract with no bypass | Unit | P1 | FR-062-AC-1..FR-062-AC-7, FR-062-AC-9 | ✅ Passed locally for AC-2, AC-5 (hook level) and AC-12; partly for AC-3 (third clause only), AC-6 (first sentence only) and AC-4 (QSL-140: the no-kind clause passes, the with-kind clause is pending QSL-42); AC-1 owned by QSL-140/QSL-242; AC-7 unbacked pending FR-096 (QSL-160); AC-9 unbacked (QSL-242) |
| TC-161 | The seam probe demonstrates exhaustiveness at every S1-S4 seam | Integration | P1 | FR-063-AC-1..FR-063-AC-7, FR-062-AC-8, FR-067-AC-4 | ✅ Passed locally for FR-062-AC-8 (`CheckCause::code`, QSL-152, verified by a real `cargo xtask seam-probe` run); FR-063/FR-067's own criteria remain 🚧 Planned (QSL-149) |
