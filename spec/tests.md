...
| TC-383 | The S6a Relation arm refuses FamilyNotNativelyEvaluable without evaluating or charging | Unit | P1 | FR-090-AC-2 | 🚧 Planned; QSL-174 |
| TC-384 | A consumed evaluation environment is an InternalFault, not a panic or a refusal | Unit | P1 | FR-090-AC-3 | 🚧 Planned; QSL-174 |
...
`Refusal`. TC-382 to TC-390 are `🚧 Planned` under QSL-174, one per
criterion. TC-390 uses the resolved-import and definition-scan approach of
