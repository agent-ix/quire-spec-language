...
| TC-160 | Every family implements the six-part checked contract with no bypass | Unit | P1 | FR-062-AC-1..FR-062-AC-7, FR-062-AC-9, FR-062-AC-13, FR-057-AC-10 | ✅ Passed locally for AC-2, AC-4 (step 5, QSL-266), AC-5 (hook level), AC-7 backed by TC-378, AC-12, and AC-13 (steps 10 and 11, QSL-266); partly for AC-3 (third clause only, QSL-246 owns the rest) and AC-6 (first sentence only, QSL-246 owns the rest); AC-1, AC-9 and AC-5's third clause amended by QSL-242 (no `package` hook; S4 emitter omission closure) and unbacked: steps 1, 8 and step 6's `Incomplete` assertion have no tagged test (Remaining work: QSL-283) |
...
| TC-395 | S2 refuses an inadmissible source and a unit holding a declaration with no dispatch entry | Unit | P1 | FR-091-AC-4, FR-091-AC-5, FR-091-AC-6 | 🚧 Partial: steps 1 to 3 pass locally (`qsl-forms/tests/it/value_forms.rs`); steps 4 and 5 (amended FR-091-AC-6) planned, QSL-275 |
...
| TC-406 | Each S2 and assembler cause maps to its catalog code with an exhaustive match | Unit | P1 | FR-091-AC-21 | 🚧 Planned; QSL-141; `stage_limit_exceeded` code needs QSL-160; the enum, dimension and unit causes QSL-275; the topology cause STD-112 |
...
| TC-480 | S2 builds enum and predicate forms | Unit | P1 | FR-091-AC-25, FR-091-AC-26 | 🚧 Planned; QSL-275 |
| TC-481 | The assembler admits source enums and predicates, which check and lowering then use | Integration | P1 | FR-091-AC-27, FR-091-AC-28, FR-091-AC-29, FR-091-AC-30, FR-092-AC-13 | 🚧 Planned; QSL-275 |
| TC-482 | S2 builds dimension and unit forms | Unit | P1 | FR-091-AC-31 | 🚧 Planned; QSL-275 |
| TC-483 | The assembler admits source dimensions and units into a UnitGraph and refuses each source error | Unit | P1 | FR-091-AC-32, FR-091-AC-33, FR-091-AC-34, FR-091-AC-35 | 🚧 Planned; QSL-275; AC-35's catalog code awaits STD-112 |
...
declarations and their `UnitGraph` (FR-091-AC-31 to AC-35), all planned
under QSL-275; AC-35's catalog code awaits STD-112. TC-404 backs FR-003-AC-7
