...
| C-27 | `BackendId` ↔ `backend` wire member | #185 registry type, each reader | Identity kept verbatim; digest domain checked first | FR-075-AC-6 (TC-433): round trip and adverse tests in `qsl-route/src/lib.rs` |
