...
- **AD-016** (QSpec, accepted): the seven-arrow extension path, the Shared-type
  ...
  record proposes no rename. Seven cells of this record differ from accepted
  AD-016 text. They are AD-016 amendments: QC-13 to QC-17 (OQ-3 ruling),
  QC-20, the Packet row's `ReplaySource`, and QC-21, the kernel row's
  `PopulationId` (O-13 Population row, QSL-172). The affected implementation
