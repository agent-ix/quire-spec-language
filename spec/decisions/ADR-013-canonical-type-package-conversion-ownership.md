...
| QC-28 | `quire.native.diagnostics/v1` `stage_limit_exceeded`: the cause for each of IR's checked-package reader limits `Edges`, `Occurrences` and `Diagnostics`, which none of the four causes names (FR-096-OQ-1). STD-95 answers it; Remaining work: QSL-236. | #213 S-5b's I2 limit conversion |
