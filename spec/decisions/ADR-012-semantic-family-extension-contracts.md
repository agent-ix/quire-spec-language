...
| AC-6's second sentence (every other family's `evaluate` hook reads no CST, token or display string) (FR-062-AC-6; AC-3's three clauses are now backed by `TC-160`, QSL-246) | [QSL-246](https://linear.app/agent-ix/issue/QSL-246) |
