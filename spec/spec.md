...
| [FR-082](functional/FR-082-resolve-conformance-subsetting-and-redefinition.md) | FR | Specified under #120 (QSL-120); most backing code and 16 of 30 TCs predate this spec (retrospective coverage from #131) — see `spec/tests.md`; remaining work: #120. Check-time ceilings reclassified as stage limits by ADR-014 §1 (AC-6, AC-7); code change is QSL-140's |
