...
| [FR-095](functional/FR-095-occurrence-keyed-source-map-and-locus.md) | FR | Specified and implemented under QSL-159 (ADR-013 §7 S-4: O-07, O-12, T-5, C-14) -- TC-420 to TC-422 pass locally; `LocatedSpan` replacement, C-21 and check-stage regions wait on a defined source authority (see its Status) |
