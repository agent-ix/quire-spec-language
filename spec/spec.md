...
| [FR-089](functional/FR-089-carry-population-identity-across-the-kernel-boundary.md) | FR | Specified under QSL-172 and ADR-013 O-13's Population row (QC-21); not yet implemented — see `spec/tests.md`; remaining work: QSL-131 Slice B |
| [FR-089](functional/FR-089-consolidate-value-accounting-onto-kernel.md) | FR | Specified and implemented under Linear QSL-166 (ADR-011 §6.1 K-leaf rule, QSL-166 row) — see TC-271 |
