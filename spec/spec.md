...
| [FR-090](functional/FR-090-return-a-family-outcome-or-a-typed-family-refusal.md) | FR | Specified under QSL-174 (ADR-013 O-16, O-17, T-4, T-6); not yet implemented -- TC-382–TC-391, TC-407 and TC-408 planned. Open questions FR-090-OQ-2 (no catalog code for `FamilyNotNativelyEvaluable`), OQ-3 (where location and losses travel) |
