...
| [FR-092](functional/FR-092-key-type-parameter-and-declared-nodes.md) | FR | Specified under QSL-208 (ADR-013 O-04, OQ-G, QC-18, QC-24); to be implemented by QSL-156 A4b -- TC-413 and TC-414 planned |
| [FR-093](functional/FR-093-lower-checked-value-expressions-to-fr-322-terms.md) | FR | Specified under QSL-208; to be implemented by QSL-156 A4b (lowering and keys in `check`) and serialized by QSL-6 S1b -- TC-415 and TC-416 planned |
| [FR-094](functional/FR-094-key-model-owned-reference-population-and-quantity-nodes.md) | FR | Specified under QSL-210 (ADR-013 O-04, C-02, QC-25, QC-26); to be implemented by QSL-156 A4b -- TC-417 to TC-419 planned |
