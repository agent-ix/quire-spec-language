...
| --- | --- | --- |
| [FR-001](functional/FR-001-read-exact-source.md) | FR | Draft; AC-5 to AC-7 (the caller-named `RawSourceRef`, TC-423) specified under QSL-233 for ADR-013 §7 S-4b, not implemented |
...
| [FR-010](functional/FR-010-report-native-outcomes.md) | FR | Draft; AC-11 (the four source labels, TC-424) specified under QSL-233 for ADR-013 §7 S-4b, not implemented |
...
| [FR-096](functional/FR-096-stage-limits-refusal-records-and-readers-carry-a-locus.md) | FR | Specified under QSL-160 (ADR-013 §7 S-5b: T-4, O-17, O-22 with T-5 loci); not implemented -- TC-425 to TC-428 planned; gated on S-4b, FR-091-AC-10 (QSL-141) and QC-28; AC-9 and AC-10 need three IR reader changes; open question FR-096-OQ-1 (IR's edge, occurrence and diagnostic limits, QC-28) |
