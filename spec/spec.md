...
| [FR-089](functional/FR-089-carry-population-identity-across-the-kernel-boundary.md) | FR | Specified under QSL-172 and ADR-013 O-13's Population row (QC-21); partially implemented -- QSL-131 Slice B's kernel half (FR-089-AC-2; TC-292) is inspected locally, and its kernel population-pair refusal (FR-089-AC-6; TC-297) passes locally; see `spec/tests.md`; remaining: QSL-131's other half, QSL `model` minting a `PopulationId` and the evaluator's resolution step (FR-089-AC-1, AC-3, AC-4, AC-5) |
