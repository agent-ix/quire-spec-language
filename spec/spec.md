...
| [FR-065](functional/FR-065-migrate-function-application-to-checked-family.md) | FR | Specified under #214; not yet implemented; the first family slice to implement FR-062's contract. AC-7 (the contract `check` hook's typing refusal, TC-380) is covered by untagged tests |
...
| [FR-087](functional/FR-087-typestate-and-cross-package-node-key.md) | FR | Specified under QSL-158 (ADR-013 §7 S-3a: T-1, T-3, O-15), split from QSL-158's S-3 by the 2026-09-21 ticket comment; not yet implemented. Gate (S-2, QC-10) is clear. Owner ruling 2026-09-21: `CheckedPackage` is canonically layer-4 `package`, `check` builds `CheckedGraph` (its own S3 output) instead; closes the `CheckedPackage`-placement half of QSL-167. AC-13 (E3 imported-name resolution and its missing/ambiguous refusals, TC-379) is unbacked |
