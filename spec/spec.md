...
| [FR-091](functional/FR-091-produce-value-forms-and-assemble-package-declarations.md) | FR | Specified for ADR-011 §7.3 M-3b (`Value` family, QSL-141) on the M-6a path (QSL-8); not yet implemented -- TC-392–TC-403, TC-405, TC-406, TC-412 planned. OQ-1 to OQ-5 and OQ-7 ruled (see Rulings). Open questions FR-091-OQ-9 (type-form bounds as kernel values or spelled text), OQ-10 (`unsupported_construct` for S2's unrepresented-form causes), OQ-11 (source `dimension` and `unit` meaning and codes). Enum and predicate declarations (AC-25 to AC-30) specified under QSL-275, not implemented -- TC-470, TC-471 planned |
| [FR-092](functional/FR-092-key-type-parameter-and-declared-nodes.md) | FR | Specified under QSL-208, recursion groups under QSL-211 (ADR-013 O-04, OQ-G, QC-18, QC-24); implemented on the QSL-156 A4b branch, pending merge, except recursion groups and AC-12 -- TC-413 and TC-414; AC-13 (`predicate` node, source enum nodes) under QSL-275, TC-471 planned |
