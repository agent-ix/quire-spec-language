...
| [FR-105](functional/FR-105-emit-state-nodes.md) | FR | Specified under QSL-273 (A05-3): S4 `state`/`state_clause`, `operation_anchor` and `frame` nodes, model members named by object type and member name; AC-1 to AC-3 pending STD-111 (QSpec wire); not yet implemented -- TC-462, TC-463 planned |
