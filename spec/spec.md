...
| [FR-075](functional/FR-075-compute-candidates-from-registered-backends.md) | FR | Specified under #185 (QSL-185); implemented under QSL-46 (PR #305) as `src/route.rs` over the canonical `Capability` type (QSL-173); AC-1..AC-5 backed (TC-193..TC-196); the lowering-target catalog is deleted with `lowering` in ADR-011 §7.3 M-6a |
