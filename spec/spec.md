...
| [FR-090](functional/FR-090-return-a-family-outcome-or-a-typed-family-refusal.md) | FR | Specified under QSL-174 (ADR-013 O-16, O-17, T-4, T-6); not yet implemented -- TC-382–TC-390 planned. Open questions FR-090-OQ-1 (carrier of evaluation-time family causes), OQ-2 (no catalog code for `FamilyNotNativelyEvaluable`), OQ-3 (where location and losses travel), OQ-4 (S6a arms of the four unmigrated families) |
