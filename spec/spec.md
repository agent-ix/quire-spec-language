...
| [FR-062](functional/FR-062-implement-checked-family-contract.md) | FR | Specified under #214; not yet implemented. AC-11 (package-wide expression-node limit, TC-381) is backed; AC-12 (a family limit's actual counter, TC-432) is backed |
...
| [NFR-012](non-functional/NFR-012-bound-model-normalization-and-population-admission.md) | NFR | Implemented under QSL-216, QSL-218 and QSL-222: finite default model normalization and admission ceilings, normalization charged as it works, meters that count rather than log -- TC-433 |
