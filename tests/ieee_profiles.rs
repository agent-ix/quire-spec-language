...
/// Build a wire-format [`DefinitionReference`] from the pinned catalog's
/// IEEE-profile entry. The digest fields are not checked at admission
/// (QSL-169, PLAT-887); any well-formed value is admissible.
